    ...
    <>
      ...
      <section id='section-2' >
        ...
        <div className="top">
          <div className="left">
            <h3>
            Lorem ipsum dolor <br />sit amet <br /> consectetur adipisicing <br /> elit Dolorminus
            </h3>
          </div>
          <div className="right"></div>
        </div>
        {/* <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis fugit quasi id illum. Atque omnis error in dolores maxime facere ab nisi labore accusantium sit repellat quia quam tempore, voluptatem veniam corporis ullam voluptatibus? Ut accusamus vel totam blanditiis laborum quaerat labore doloremque ullam, reprehenderit, fugit aspernatur voluptas recusandae autem?</p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis fugit quasi id illum. Atque omnis error in dolores maxime facere ab nisi labore accusantium sit repellat quia quam tempore, voluptatem veniam corporis ullam voluptatibus? Ut accusamus vel totam blanditiis laborum quaerat labore doloremque ullam, reprehenderit, fugit aspernatur voluptas recusandae autem?</p>
